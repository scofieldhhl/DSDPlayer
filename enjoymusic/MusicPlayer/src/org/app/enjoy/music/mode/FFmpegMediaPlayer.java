...
package org.app.enjoy.music.mode;
...
public class FFmpegMediaPlayer
{
    ...
    private void setDataSource(String path, String[] keys, String[] values)
        ...
        if (file.exists()) {
            ...
            is.close();
            */
            _setDataSourcePath(path,0, 0x7ffffffffffffffL);
        } else {
            _setDataSource(path, keys, values);
        }
    }

    private native void _setDataSourcePath(String path, long offset, long length)
	...
	private void writeAudio(int frame_size_ptr) {
		...
		Log.e(TAG,"FFmpegMediaPlayer writeAudio");
		return ;
	}  
